...
write.tree(result_analysis, file = "E:/Global_Rooting/Phylo_Newick/RD_Newick.tree")
...
write.table(Traits, file = "E:/Global_Rooting/Phylo_Newick/RD_Traits.txt",row.names = FALSE,col.names = FALSE)
